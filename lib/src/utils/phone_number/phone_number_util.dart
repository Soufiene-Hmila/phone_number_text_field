...
class PhoneNumberUtil {
  ...
  static Future<String?> getNameForNumber({required String phoneNumber, required String isoCode}) async {
    return p.MethodChannelPhoneNumberTextField.getNameForNumber(phoneNumber: phoneNumber, isoCode: isoCode);
  }
  ...
  static Future<bool?> isValidNumber({required String phoneNumber, required String isoCode}) async {
    ...
    return p.MethodChannelPhoneNumberTextField.isValidPhoneNumber(phoneNumber: phoneNumber, isoCode: isoCode);
  }
  ...
  static Future<String?> normalizePhoneNumber({required String phoneNumber, required String isoCode}) async {
    return p.MethodChannelPhoneNumberTextField.normalizePhoneNumber(phoneNumber: phoneNumber, isoCode: isoCode);
  }
  ...
  static Future<RegionInfo> getRegionInfo({required String phoneNumber, required String isoCode}) async {
    var response = await p.MethodChannelPhoneNumberTextField.getRegionInfo(phoneNumber: phoneNumber, isoCode: isoCode);

    return RegionInfo(regionPrefix: response.regionPrefix, isoCode: response.isoCode, formattedPhoneNumber: response.formattedPhoneNumber);
  }
  ...
  static Future<PhoneNumberType> getNumberType({required String phoneNumber, required String isoCode}) async {
    final dynamic type = await p.MethodChannelPhoneNumberTextField.getNumberType(phoneNumber: phoneNumber, isoCode: isoCode);
  ...
  static Future<String?> formatAsYouType({required String phoneNumber, required String isoCode}) async {
    return p.MethodChannelPhoneNumberTextField.formatAsYouType(phoneNumber: phoneNumber, isoCode: isoCode);
  }
}
