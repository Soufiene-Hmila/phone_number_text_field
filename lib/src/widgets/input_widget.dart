...
import 'package:phone_number_text_field/src/models/country_list.dart';
import 'package:phone_number_text_field/src/models/country_model.dart';
import 'package:phone_number_text_field/src/providers/country_provider.dart';
import 'package:phone_number_text_field/src/utils/formatter/as_you_type_formatter.dart';
...
import 'package:phone_number_text_field/src/utils/selector_config.dart';
import 'package:phone_number_text_field/src/utils/test/test_helper.dart';
import 'package:phone_number_text_field/src/utils/util.dart';
import 'package:phone_number_text_field/src/utils/widget_view.dart';
import 'package:phone_number_text_field/src/widgets/selector_button.dart';
  ...
  void loadCountries({Country? previouslySelectedCountry}) {
    if (mounted) {
      ...
      Country country = previouslySelectedCountry ??
          Utils.getInitialSelectedCountry(countries, widget.initialValue?.isoCode ?? '',);
      ...
      getParsedPhoneNumber(parsedPhoneNumberString, country?.alpha2Code).then((phoneNumber) {
        if (phoneNumber == null) {
          ...
          if (widget.onInputChanged != null) {
            widget.onInputChanged!(PhoneNumber(phoneNumber: phoneNumber,
                isoCode: country?.alpha2Code, dialCode: country?.dialCode));
          }
