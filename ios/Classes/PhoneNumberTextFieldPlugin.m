#import "PhoneNumberTextFieldPlugin.h"
#import "NBPhoneNumberUtil.h"
#import "NBAsYouTypeFormatter.h"


@interface PhoneNumberTextFieldPlugin ()
@property(nonatomic, retain) NBPhoneNumberUtil *phoneUtil;
@end

@implementation PhoneNumberTextFieldPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    FlutterMethodChannel* channel = [
        FlutterMethodChannel methodChannelWithName:@"phone_number_text_field"
        binaryMessenger:[registrar messenger]
    ];
    
    PhoneNumberTextFieldPlugin* instance = [[PhoneNumberTextFieldPlugin alloc] init];
